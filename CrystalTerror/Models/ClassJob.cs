namespace CrystalTerror
{
    ...
    /// <summary>
    /// Represents a class/job with an id, display name and abbreviation (spelled "Abreviation" per request).
    /// </summary>
    public class ClassJob
    {
        ...
        public ClassJob(int id, string name, string abreviation)
        {
            Id = id;
            Name = name;
    ...
    public static class ClassJobExtensions
    {
        ...
        /// <summary>
        /// Backwards-compatible helper to get abbreviation string (spelled `Abreviation`).
        /// </summary>
        public static string? GetAbreviation(int? id)
        {
            var cj = GetClassJob(id);
            return cj?.Abreviation;
        }
    }
}
